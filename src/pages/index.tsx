...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="flex flex-col align-middle min-h-screen bg-lightCyan font-Poppins lg:px-20 px-2 text-darkblue">
        <Navbar />
        <div className="flex flex-1 align-middle py-10 p-10 justify-around flex-col-reverse lg:flex-row">
          <div>
            <PrayingPerson />
          </div>
          <div className="flex flex-col justify-center gap-7 lg:max-w-xl text-right pb-12">
            ...
            <div className="flex justify-end gap-7 font-medium text-lg flex-col sm:flex-row">
              <Link className="rounded-full bg-ocean text-lightCyan p-1.5 px-5 text-center" href="/dashboard">Visit Board</Link>
